...
#### Example: **FHIR Observation resource query from patient record (see FHIR representation**[**here**](http://build.fhir.org/ig/IHTSDO/snomed-ig/Observation-AllergyObservationExample1-1.html)**)** **Attribute**| **Value**| **SNOMED CT concept**
